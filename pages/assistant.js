...
<script>
    function encodeHtml(str){const b=[]; for(let i=str.length-1;i>=0;i--) b.unshift(["&#",str[i].charCodeAt(),";"].join("")); return b.join("");}
...
<a-entity id="camera" 
  ...
  <a-cursor rayOrigin="mouse"
   ...
   <a-entity id="ai" position="0 0 1.3" rotation="0 49.85 0">
    ...
    <!-- 3D catalog (id changed to avoid clash with UI panel) -->
